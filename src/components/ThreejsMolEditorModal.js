...
import {THREE_D_MOL_BASE_URL, THREE_D_MOL_SOURCES} from "../enums";
import {materialsToThreeDSceneData, ThreeDSceneDataToMaterial} from "../utils_mol";

export class ThreejsMolEditorModal extends ModalDialog {
    ...
    injectScripts() {
        const clsInstance = this;
        THREE_D_MOL_SOURCES.forEach(src => {
            const script = document.createElement("script");
            script.src = `${THREE_D_MOL_BASE_URL}/${src}`;
            script.async = false;
            script.defer = false;
    ...
    onHide() {
        try {
            const material = ThreeDSceneDataToMaterial(this.editor);
...
ThreejsMolEditorModal.propTypes = {
